// To parse this data:
//
//   import { Convert, CheckListModel } from "./file";
//
//   const checkListModel = Convert.toCheckListModel(json);
//
...
export class Convert {
    public static toCheckListModel(json: string): CheckListModel {
        return cast(JSON.parse(json), r("CheckListModel"));
    }

    public static checkListModelToJson(value: CheckListModel): string {
        return JSON.stringify(uncast(value, r("CheckListModel")), null, 2);
    }
}
